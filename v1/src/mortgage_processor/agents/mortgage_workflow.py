...
try:
    ...
    from mortgage_processor.utils.message_parser import extract_message_content_and_files
except ImportError:
    from ...utils.llm_factory import get_llm
    from ...utils.message_parser import extract_message_content_and_files
...
def create_routing_node():
    ...
    def route_classifier(state: MortgageRoutingState):
...
def create_mortgage_routing_workflow():
    ...
    # Add routing classifier node
    routing_classifier = create_routing_node()
    workflow.add_node("route_classifier", routing_classifier)
    ...
    # Entry point: route classification
    workflow.add_edge("__start__", "route_classifier")
