...
from mortgage_processor.agents.underwriting_agent import create_underwriting_agent
from mortgage_processor.agents.underwriting_agent.tools import get_all_underwriting_agent_tools
...
class TestUnderwritingAgentCreation:
    ...
    def test_import_structure(self):
        ...
        try:
            ...
            # Test tools imports
            from mortgage_processor.agents.underwriting_agent.tools import (
                analyze_credit_risk,
                calculate_debt_to_income,
                evaluate_income_sources,
                make_underwriting_decision,
            ...
            from mortgage_processor.agents.underwriting_agent.tools.analyze_credit_risk import analyze_credit_risk as credit_tool
            from mortgage_processor.agents.underwriting_agent.tools.calculate_debt_to_income import calculate_debt_to_income as dti_tool
            from mortgage_processor.agents.underwriting_agent.tools.evaluate_income_sources import evaluate_income_sources as income_tool
