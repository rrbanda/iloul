...
Usage:
    # Functionality tests
    from mortgage_processor.agents.application_agent.tests import run_all_application_agent_tests
    results = run_all_application_agent_tests()
    
    # Professional LLM/agent evaluations
    from mortgage_processor.agents.application_agent.tests import run_langsmith_evaluations
